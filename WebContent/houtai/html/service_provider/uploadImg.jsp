...
<html>
						...
						<div class="tab-pane active" id="home">
							<div class="row data-type">
								...
								<div class="filePic">
									...
									<img id="preview" style="width: 340px;" class="am-circle am-img-thumbnail" src="<%=basePath%>/images/service/service_${aac102}.jpg" alt="" />
									<br>
									<%--
    ...
    function uploadFile(ev){
       ...
       // var ftype = "user_${user.aaa102}";
        ...
        $.ajax({
    		url:"<%=basePath%>/fileUpload.ajax?type=service&id=${aac102}",
    		type:"post",
    		dataType:"json",
    		processData : false,
    		contentType : false,
