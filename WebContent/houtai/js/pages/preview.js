(function(){
    ...
    Preview.prototype = {
        ...
        init: function(){
            ...
            this.imgBg.innerHTML = '<div class="popurNode" style="position: absolute;left:0;top:0;width:100%;height:100%;z-index:10000"></div><span style="position: absolute;top: 50px;right:50px;z-index: 10000;height: 48px;width: 48px;background:red;cursor:pointer;border-radius:50%;" class="close_bgmask"></span><div style="position:absolute;left:50%;top:50%;" class="view_img_wrap"><img style="width:100%;height:100%;position: relative;z-index: 10000;" src="" alt=""></div>';
