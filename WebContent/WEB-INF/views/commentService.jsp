...
<html>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#comment3 li").click(function() {	
					...
					var p = $(this).val();
					$('input[name="aac507"]').val(p);
					$("#point3").text(p);
				});
				
	    	 })
	    	function sendComment(vaac402)
			{
				var vform = document.getElementById("myform");
				$('input[name="aac503"]').val($("#comment_text").val());
				vform.action="<%=path%>/commentService.html?aac402="+vaac402;
				vform.submit();
			}
		</script>
	...
	<body>
		...
		<input name="aac507" type="hidden"/>
		<input name="aac503" type="hidden"/>
		</form>
		<!--头 -->
		<header>
			<article>
						...
						<div class="comment-main">
							...
							<div class="comment-list">
								...
								<div class="item-title">
									<div class="item-name">
										<a href="#">
											<p class="item-basic-info">服务商:${ins.aac103 }</p>
										</a>
									</div>
									<div class="item-info">
							...
							<div class="info-btn" onclick="sendComment(${ins.aac402})">
