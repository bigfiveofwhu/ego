...
<%
	...
	//订单名称，必填
	String subject = new String(request.getAttribute("WIDsubject").toString().getBytes("ISO-8859-1"),"UTF-8");
	//商品描述，可空
	String body = new String(request.getAttribute("WIDbody").toString().getBytes("ISO-8859-1"),"UTF-8");
