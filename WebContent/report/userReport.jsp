...
<div class="layui-tab">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <label>月度商品消费：${map.shopSumMonth}</label><br>
            <label>月度服务消费：${map.serviceSumMonth}</label><br>
            <label>月度总消费：${map.sumMonth}</label><br><br>
            <label>年度商品消费：${map.shopSumYear}</label><br>
            <label>年度服务消费：${map.serviceSumYear}</label><br>
            <label>年度总消费：${map.sumYear}</label><br><br>
            <label>生涯商品消费：${map.shopSumAll}</label><br>
            <label>生涯服务消费：${map.serviceSumAll}</label><br>
            <label>生涯总消费：${map.sumAll}</label><br>
        </div>
        <div class="layui-tab-item">
            <table lay-filter="user-table">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'type', sort: true}">交易类型</th>
                    <th lay-data="{field:'name', sort: true}">交易对象</th>
                </tr>
                </thead>
                <tbody>
