...
<head>
    ...
    <link href="<%=path %>/css/shop/detail1.css" rel="stylesheet" type="text/css"/>
    <link href="<%=path %>/css/shop/detail2.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<%=path %>/js/shop/base.js"></script>
    <script> var curl = {apiName: 'require'}; var MOGU = {}; var MoGu = {};</script>
    <script type="text/javascript">
        var MOGU_DEV= 0;
        if(window.require) {
            require.config({
...
<script type="text/javascript">
    ...
    (function(){
        ...
        window.eGO && $.isFunction(eGO.set) && eGO.set('initTime', (new Date()).getTime());
    })();
</script>
...
<div class="shop-header">
    <div class="header clearfix">
        <div class="user-info fl">
            <a href="#" class="avatar" title="${aab103 }">
                <img class="face fl" src="${shop.url }">
            </a>
            <div class="shop-name fl">
                <div class="name-wrap clearfix">
                    <a href="shop.html#110fni1q" class="name fl" title="${aab103 }">${aab103 }</a>
                    <p class="mark">
                ...
                <div class="shop-score J-show-shop-score">
                    <p>
                        <span class="s-cat">描述<b  class="low" >${aab111 }</b></span>
                        <span class="s-cat">价格<b  class="low" >4.77</b></span>
                        <span class="s-cat">物流<b >${aab109 }</b></span>
                        <span class="s-cat">服务<b  class="low" >${aab110 }</b></span>
                    </p>
                    <!-- 下拉列表 -->
            ...
            <div class="shop-action fl">
                ...
                <c:choose>
                <c:when test="${isCollect }"> 已收藏</c:when>
                <c:otherwise><span id="collect">收藏</span></c:otherwise>
                </c:choose>
                </a>
                <a href="javascript:;" class="chart fl clearfix">
                    <div class="mlstalk_widget_btn kefu fl" style="cursor:pointer" data-style="widget4" 
                    	 data-toid="1256898643" data-tid="4170704471" data-shopid="110fni1q">联系客服</div>
                </a>
            </div>
            ...
            <div id="nav_search_form" class="top_nav_search">
                <form target="_blank" action="/search" method="get" id="top_nav_form">
                    <div class="text-wrap clearfix">
                        <input type="text" id="J_SearchKey" class="text ts_txt" autocomplete="off" name="searchKey" placeholder="输入你想要的商品..." data-tel="search_book" data-def="" def-v="" />
                        <a href="javascript:;" data-baseurl="shop.html#110fni1q" id="J_SearchInShop" class="search-inshop">搜本店</a>
...
<input type="hidden" id="shopBaseUrl" value="shop.html#">
<input type="hidden" id="shopBaseUrlSec" value="shop.html#110fni1q">
<!-- topBanner -->
    ...
    <div class="mod_list clearfix">
        <div class="mod_item w1200" data-id="4634908" data-width="1200" data-type="topBanner" data-title="$commonTopBanner.layoutname">
            <div class="mod_cont topbanner">
                <a class="shop_bg_img" href="#" 
                   data-src="<%=path %>/images/product/product_id.jpg" 
                   style="background: url(<%=path %>/images/product/product_id.jpg) center no-repeat">
                </a>
            </div>
        </div>
    </div>
...
<div class="ovbox mod_topNav blackStyle">
    <div class="mod_list clearfix">
        <div class="mod_item w1200" data-id="4634909" data-width="1200" data-type="topNav" data-title="$commonTopNav.layoutName">
            <div class="mod_cont topNav">
                <ol class="clearfix">
                    ...
                    <li><a href="#">时尚套装</a></li>
                    <li><a href="#">T恤针织衫</a></li>
                    <li><a href="#">特惠专区</a></li>
                    <li><a href="#">夏装上新</a></li>
                    <li><a href="#">半身裙/短裤</a></li>
                    <li><a href="#">阔腿裤</a></li>
                </ol>
...
<div id="body_wrap">
            ...
            <div class="primary-goods">
                <div class="clearfix">
                    <div class="fl goods-info goods-info-tuan-pre" id="J_GoodsInfo">
                        <div class="info-box">
                                ...
                                <div class="clearfix main-box">
                                    <dl class="clearfix property-box">
                                        ...
                                        <dd class="property-cont property-cont-origin">
                                            &yen;<span id="J_OriginPrice" class="price">${old_aab205 }</span>
                                        </dd>
                                    </dl>
                                    <dl class="clearfix property-box">
                                        <dt class="property-type property-type-now" > 现价 ：</dt>
                                        <dd class="property-cont property-cont-now fl">
                                            <span class="price" style="color: #333333">&yen;<span id="J_NowPrice">${aab205 }</span></span>
                                            <em class="pre-price-desc">（特卖价 &yen;${sale_price }）</em>
                                        </dd>
                                        <dd class="property-extra fr">
										    ...
										    <span>累计销量：
										      <span class="num J_SaleNum">${sale_count }</span>
										    </span>
                                        </dd>
                                    </dl>
                                    ...
                                    <div class="box">
                                        ...
                                        <dl class="clearfix">
                                            ...
                                            <dd class="num clearfix">
                                                ...
                                                <div class="J_GoodsStock goods-stock fl">库存${repertory }件</div>
                            ...
                            <div class="goods-social clearfix">
                                <div class=" fav  item" goodsid="0" tradeitemid="1fxighu" tid="0"><b></b><span class="fav-num">${collect_count }</span></div>
                            ...
                            <div class="goods-extra clearfix">
                                <div class="extra-services">
                                    ...
                                    <ul class="fl clearfix list">
                                        <li class="item">
                                          <span class="link">
                                            <img src="<%=path %>/images/product/productReturn.png" width="24" height="24">
                                                                                                              退货补运费
                                          </span>
                                        </li>
                                        <li class="item">
                                        <span class="link">
	                                         <img src="<%=path %>/images/product/productReturn_7.png" width="24" height="24">
	                                          7天无理由退货
                                        </span>
                                        </li>
                                        <li class="item">
                                        <span class="link">
                    					  <img src="<%=path %>/images/product/compensate.png" width="24" height="24">
                 							   先行赔付
               							</span>
                                        </li>
                                        <li class="item">
                                           <span class="link">
                    					   <img src="<%=path %>/images/product/productDeliver.png" width="24" height="24">
                    						72小时发货
                							</span>
                                        </li>
                                    </ul>
                    ...
                    <div class="fl goods-topimg" id="J_GoodsImg">
                        <div class="big-img">
                            <button class="middle">
                                <img id="J_BigImg" src="<%=path %>/images/product/product_id.jpg" data-main="<%=path %>/images/product/product_id.jpg" alt="雪纺裙,收腰,淑女,夏季新品,系带" width="400">
                            </button>
                        </div>
                    ...
                    <div class="tabbar-box">
                        <ul class="tabbar-list clearfix">
                            ...
                            <li data-panels="rates" data-hasnav="false">
                                <a href="javascript:;">累计评价<em>57</em></a>
                            </li>
                                ...
                                <div class="rates-buyer">
                                    ...
                                    <div class="comment-content">
                                        ...
                                        <div class="nav clearfix">
                                            ...
                                            <a href="javascript:;" data-type="all" class="c">全部评价（57）</a>
                                            <a href="javascript:;" data-type="img" class="">晒图（10）</a>
                                        </div>
                                        <!-- 列表 -->
    ...
    <script type="text/javascript">
        ...
        var eGODetail = {
            ...
            util: {
                isMGJApp: (function(){
                    return eGOConstant.userAgent.indexOf('nonative') < 0 && eGOConstant.userAgent.indexOf('mogujie') > 0;
                }()),

                isMobile: (function(){
                    return eGOConstant.mobileRegex.test(eGOConstant.userAgent);
                }()),

                isWeChat: (function(){
                    return eGOConstant.userAgent.indexOf('micromessenger') > 0;
                }())
            }
        };
    </script>
    <script type="text/javascript">
        ...
        // 如果在移动设备上
        else if(eGODetail.util.isMobile){
            setTimeout(function(){
    ...
    <div class="wrap foot_wrap clearfix">
        <div class="foot_info">
            ...
            <div class="info_text">
                ...
                <p class="mgjhostname" title="<?php echo gethostname();?>">&copy;<? echo date("Y") ?> meilishuo.com 北京美丽时空网络科技有限公司</p>
            </div>
        </div>
        <div class="foot_link">
...
<script type="text/javascript" src="<%=path %>/js/shop/index1.js"></script>
<script type="text/javascript" src="<%=path %>/js/shop/index2.js"></script>
</body>
</html>
