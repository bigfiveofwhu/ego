...
<link href="${url}/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet"
	type="text/css" />
<link href="${url}/AmazeUI-2.4.2/assets/css/amazeui.css"
...
<script type="text/javascript"
	src="${url}/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
...
<script type="text/javascript" src="${url}/js/linkage.js"></script>

<script type="text/javascript" src="${url}/js/introduction.js"></script>
		...
		<ul class="message-r">
			...
			<div class="topMessage my-shangcheng">
				<div class="menu-hd MyShangcheng">
					<c:choose>
						<c:when test="${USER_IN_SESSION!=null}">
							<a href="shoppingPro/person/information.jsp" target="_top"><i
		...
		<div class="scoll">
			<section class="slider">
				<div class="flexslider">
					<ul class="slides">
						<li><img src="${url}/images/01.jpg" title="pic" />
						</li>
						<li><img src="${url}/images/02.jpg" />
						</li>
						<li><img src="${url}/images/03.jpg" />
						</li>
					</ul>
				</div>
			</section>
		...
		<div class="item-inform">
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="${url}/images/01.jpg"><img src="${goodInfo.path}"
							alt="细节展示放大镜特效" rel="${goodInfo.path}" class="jqzoom" /> </a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="${goodInfo.path}"
									mid="${goodInfo.path}" big="${goodInfo.path}"> </a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
			...
			<div class="clearfixRight">
				...
				<div class="tb-detail-hd">
					...
					<h1>${goodInfo.name} ${goodInfo.introduce}</h1>
				</div>
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${goodInfo.price}</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${goodInfo.costprice}</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
							...
							<div class="theme-popover">
								...
								<div class="theme-popbod dform">
									<form class="theme-signin" name="loginform"
										action="${pageContext.request.contextPath}/introduction?cmd=buy"
										method="post" content_form>
					
										<!-- 隐藏域传ID给servlet -->
										<input type="hidden" name="goodIdInput" value="${goodInfo.id}">
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<ul>
													<!-- 	<li class="sku-line selected"><input type="radio" name="kouwei" value="原味" checked>原味<i></i></li>
															<li class="sku-line"><input type="radio" name="kouwei" value="奶油">奶油<i></i></li>
															<li class="sku-line"><input type="radio" name="kouwei" value="炭烧">炭烧<i></i></li>
															<li class="sku-line"><input type="radio" name="kouwei" value="咸香">咸香<i></i></li> -->
													<%
														//String sss = "新乡,洛阳,郑州,鹤壁";
														String sss = request.getAttribute("list").toString();
														//out.println(sss);
														application.setAttribute("string1", sss);

														String pack = request.getAttribute("pack").toString();
														application.setAttribute("string2", pack);
													%>
													<!-- 逗号要注意写对 -->
													<c:set value="${fn:split(string1,'，')}" var="str1"></c:set>
													<c:forEach items="${str1}" var="list" varStatus="vs">
														<li class="sku-line ${vs.count==1?'selected':''}"><input
															type="radio" name="kouwei" value="${list}" id="kouwei${goodInfo.id}">${list}<i></i>
														</li>
													</c:forEach>
												</ul>
											</div>
											<div class="theme-options">
												...
												<ul>
													<!-- <li class="sku-line selected"><input type="radio"
														name="baozhuang" value="手袋单人份" checked>手袋单人份<i></i>
													</li>
													<li class="sku-line"><input type="radio"
														name="baozhuang" value="礼盒双人份">礼盒双人份<i></i>
													</li>
													<li class="sku-line"><input type="radio"
														name="baozhuang" value="全家福礼包">全家福礼包<i></i>
													</li> -->
													<c:set value="${fn:split(string2,'，')}" var="str2"></c:set>
													<c:forEach items="${str2}" var="list" varStatus="vs">
														<li class="sku-line ${vs.count==1?'selected':''}"><input
															type="radio" name="baozhuang" value="${list}" id="baozhuang${goodInfo.id}">${list}<i></i>
													</c:forEach>
												</ul>
											</div>
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														...
														name="number" type="text" value="1" style="width:30px;" />
													<input id="add" class="am-btn am-btn-default" name=""
														type="button" value="+" /> <span id="Stock"
														class="tb-hidden">库存<span class="stock">${goodInfo.stock}</span>件</span>
												</dd>
			...
			<div class="pay">
				...
				<li>
					<div class="clearfix tb-btn tb-btn-buy theme-login">
						<a id="LikBuy" title="点此按钮到下一步确认购买信息" href="javascript:document:loginform.submit();">立即购买</a>
					</div>
				</li>
				<li>
					<div class="clearfix tb-btn tb-btn-basket theme-login">
						<a id="LikBasket" title="加入购物车"
							href=""><i></i><div onclick="showCart(${goodInfo.id})">加入购物车</div></a>
					</div>
				</li>
			</div>
	...
	<div class="match">
		...
		<div class="match-comment">
			<ul class="like_list">
				<li>
					<div class="s_picBox">
						<a class="s_pic" href="#"><img src="${url}/images/cp.jpg">
						</a>
				...
				<li>
					<div class="s_picBox">
						<a class="s_pic" href="#"><img src="${url}/images/cp2.jpg">
						</a>
		...
		<div class="browse">
			<div class="mc">
				<ul>
					...
					<li class="first">
						<div class="p-img">
							<a href="#"> <img class="" src="${url}/images/browse1.jpg">
							</a>
						</div>
						<div class="p-name">
		...
		<div class="introduceMain">
			<div class="am-tabs" data-am-tabs>
				<ul class="am-avg-sm-3 am-tabs-nav am-nav am-nav-tabs">
					...
					<li><a href="#" id="click"> <span
							class="index-needs-dt-txt">全部评价</span> </a>
					</li>
					<!-- 展现你喜欢的商品 -->
					<li><a href="javascript:void(0)" class="showFav"><span
							class="index-needs-dt-txt">猜你喜欢</span> </a>
					</li>
				</ul>
					...
					<div class="am-tab-panel am-fade am-in am-active">
						...
						<div class="details">
							...
							<div class="twlistNews">
								<img src="${url}/images/tw1.jpg" /> <img
									src="${url}/images/tw2.jpg" /> <img
									src="${url}/images/tw3.jpg" /> <img
									src="${url}/images/tw4.jpg" /> <img
									src="${url}/images/tw5.jpg" /> <img
									src="${url}/images/tw6.jpg" /> <img
									src="${url}/images/tw7.jpg" />
							</div>
						</div>
						<div class="clear"></div>
   	   			 ...
   	   			 %>
						<c:choose>
							<c:when test="${USER_IN_SESSION!=null}">
								...
								<textarea id="write" name="comment" rows="3" cols="149"
									placeholder="请输入评论"></textarea>
								<input type="button" value="发表评论" id="subcomment">
							</c:when>
						</c:choose>

							<ul id="commentId" class="am-comments-list am-comments-list-flip">
							</ul>
		...
		<div id="sidebar">
			<div id="wrap">
					...
					<div class="ibar_login_box status_login">
						<div class="avatar_box">
							<p class="avatar_imgbox">
								<img src="${url}/images/no-img_mid_.jpg" />
							</p>
							<ul class="user_info">
								<li>用户名：sl1903</li>
								<li>级&nbsp;别：普通会员</li>
				...
				<div id="shopCart" class="item">
					...
					<p onclick="javascript:window.open('/shoppingPro/shoppingCart?cmd=showCart')">购物车</p>
				...
				<div id="brand" class="item">
					<a href="#"> <span class="wdsc"><img
							src="${url}/images/wdsc.png" /> </span> </a>
					<div class="mp_tooltip">
				...
				<div id="broadcast" class="item">
					<a href="#"> <span class="chongzhi"><img
							src="${url}/images/chongzhi.png" /> </span> </a>
					<div class="mp_tooltip">
				...
				<div class="quick_toggle">
					...
					<li class="qtitem"><a href="#none"><span
						...
						<div class="mp_qrcode" style="display:none;">
							<img src="${url}/images/weixin_code_145.png" /><i
