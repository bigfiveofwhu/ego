					...
					<div class="login-form">
					   <form action="<%=path %>/login" method="post">
						    <div class="user-name">
							    ...
							    <input type="text" name="username" id="user" placeholder="ÓÊÏä/ÊÖ»ú/ÓÃ»§Ãû">
			                </div>
			                <div class="user-pass">
							    <label for="password"><i class="am-icon-lock"></i></label>
							    <input type="password" name="password" id="password" placeholder="ÇëÊäÈëÃÜÂë">
			                </div>
			                <div class="user-pass">
							    <label for="password"><i class="am-icon-rocket"></i></label>
							    <input type="password" name="verifyCode" id="verifyCode" placeholder="ÇëÊäÈëÑéÖ¤Âë">
			                </div>
			                <div class="am-cf">
